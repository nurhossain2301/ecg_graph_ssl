...
#SBATCH -t 1:00:00
#SBATCH -e /work/nvme/bebr/mkhan14/ecg_foundation_model/infant_vs_caregiver/slurm_outputs/slurm-%j.err
#SBATCH -o /work/nvme/bebr/mkhan14/ecg_foundation_model/infant_vs_caregiver/slurm_outputs/slurm-%j.out
...
#     --freeze_encoder 1 \
#     --seed 42 \
#     --run_name "sft_brp-infant-vs-caregiver_v1.0_window_sec_10"
