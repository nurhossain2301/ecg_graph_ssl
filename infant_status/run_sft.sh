...
#SBATCH -t 14:00:00
#SBATCH -e /work/nvme/bebr/mkhan14/ecg_foundation_model/infant_status/slurm_outputs/slurm-%j.err
#SBATCH -o /work/nvme/bebr/mkhan14/ecg_foundation_model/infant_status/slurm_outputs/slurm-%j.out
