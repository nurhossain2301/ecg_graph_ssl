...
#SBATCH -t 20:00:00
#SBATCH -e /work/nvme/bebr/mkhan14/ecg_foundation_model/ibi_graph_model/slurm_outputs/slurm-%j.err
#SBATCH -o /work/nvme/bebr/mkhan14/ecg_foundation_model/ibi_graph_model/slurm_outputs/slurm-%j.out
