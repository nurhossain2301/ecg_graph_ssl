...
torchrun --nproc_per_node=4 main.py \
    --output_dir "/work/nvme/bebr/mkhan14/ecg_foundation_model/ibi_graph_model/experiments/ibi_graph_baseline" \
    --run_name   "ibi_graph_baseline" \
    --loss_type  "baseline"
