#!/bin/bash
#SBATCH --job-name=sft_status_cosine
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_status/graph_byol_v4_mse_nodrop_cosine"
...
python main.py \
    ...
    --head_type      cosine \
    --seed           42 \
    --run_name       "sft_status_graph_byol_v4_cosine"
