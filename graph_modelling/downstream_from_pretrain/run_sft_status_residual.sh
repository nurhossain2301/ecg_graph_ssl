#!/bin/bash
#SBATCH --job-name=sft_status_residual
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_status/graph_byol_v4_mse_nodrop_residual"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_status_graph_byol_v4_residual"
