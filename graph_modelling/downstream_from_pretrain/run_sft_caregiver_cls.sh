#!/bin/bash
#SBATCH --job-name=sft_caregiver_cls
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_caregiver/graph_byol_v4_mse_nodrop_cls"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_caregiver_graph_byol_v4_cls"
