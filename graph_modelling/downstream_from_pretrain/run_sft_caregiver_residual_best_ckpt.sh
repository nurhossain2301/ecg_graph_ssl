#!/bin/bash
#SBATCH --job-name=sft_caregiver_res_best
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_caregiver/graph_byol_v4_mse_nodrop_residual_best_ckpt"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_caregiver_graph_byol_v4_residual_best_ckpt"
