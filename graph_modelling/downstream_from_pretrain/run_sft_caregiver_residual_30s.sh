#!/bin/bash
#SBATCH --job-name=sft_care_res_30s
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_caregiver/graph_byol_v4_mse_nodrop_residual_30s"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_caregiver_graph_byol_v4_residual_30s"
