#!/bin/bash
#SBATCH --job-name=sft_sleep_residual
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_sleep/graph_byol_v4_mse_nodrop_residual"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_sleep_graph_byol_v4_residual"
