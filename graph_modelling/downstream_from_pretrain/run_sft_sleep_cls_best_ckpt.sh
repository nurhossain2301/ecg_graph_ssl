#!/bin/bash
#SBATCH --job-name=sft_sleep_cls_best
...
EXPERIMENT_DIR="$PWD/brp_sft_experiments_sleep/graph_byol_v4_mse_nodrop_cls_best_ckpt"
...
python main.py \
    ...
    --seed           42 \
    --run_name       "sft_sleep_graph_byol_v4_cls_best_ckpt"
